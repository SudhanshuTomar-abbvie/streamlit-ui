...
def render_chat_page():
    ...
    with st.container():
        ...
        elif st.session_state.get("show_doc_notification", False):
    ...
    with cols[1]:
        ...
        # Only show document count notification when not in document mode
        # and we're not showing temporary upload notification
        docs = get_uploaded_documents()
