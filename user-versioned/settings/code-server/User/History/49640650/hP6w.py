...
def render_chat_page():
    ...
    with st.container():
        ...
        # Remove temporary document notification logic from here
        # It should only display in document mode, which is handled above
    ...
    with cols[1]:
        ...
        # Don't show any document count notification here - we'll handle it in document mode above
