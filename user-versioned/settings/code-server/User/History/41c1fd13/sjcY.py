...
# Constants
BACKEND_API_BASE_URL = "http://dku-mad-service-chat-on-mlops-poc:12000/public/api/v1""dku-mad-mlopschatbot-on-mlops-poc"
API_ENDPOINT = "http://dku-mad-service-chat-on-mlops-poc:12000/public/api/v1" #f"{BACKEND_API_BASE_URL}/chat/generate/run"
