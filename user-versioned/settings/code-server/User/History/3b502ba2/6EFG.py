...
if st.session_state.current_page == "home":
    ...
    st.markdown('<p style="text-align:center !i
    mportant;" >A generative AI chatbot designed to provide insights about patient touchpoints and healthcare experiences.</p>', unsafe_allow_html=True)
