...
# Chat page
    ...
    # with col2:
    #     st.markdown('<div style="margin-top: 20px !important;" class="input-button">', unsafe_allow_html=True)
    ...
    # Start main chat container
    st.markdown('<div class="chat-wrapper">', unsafe_allow_html=True)

    # Chat messages area (scrollable if needed)
    st.markdown('<div class="chat-container">', unsafe_allow_html=True)
