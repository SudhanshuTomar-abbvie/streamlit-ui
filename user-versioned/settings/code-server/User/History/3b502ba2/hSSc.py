...
if st.session_state.current_page == "home":
    ...
    st.markdown('<h1 class="welcome-title">Welcome to MLOPS Chatbot</h1>', unsafe_allow_html=True)
    st.markdown('<p class="welcome-subtitle">Patient Touchpoint Knowledge Agent</p>', unsafe_allow_html=True)
    st.markdown('<p>A generative AI chatbot designed to provide insights about patient touchpoints and healthcare experiences.</p>', unsafe_allow_html=True)
