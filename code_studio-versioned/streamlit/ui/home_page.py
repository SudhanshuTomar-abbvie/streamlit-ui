...
def render_home_page():
    ...
    popular_questions = [
        "What are support programs currently available under each drug brand?",
        "How to enroll a patient into the Bridge Program?",
        "What are leakage nodes which hinder patient conversion?",
        "What are typical patient journey patterns?"
    ]
